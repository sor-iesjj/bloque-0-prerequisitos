...
> 1. **Prepárate primero (sin grabar):** comprueba lo necesario, **léete el procedimiento entero** y **crea la entrada de apuntes de esta fase** en Obsidian: fichero `b0-0.2.1-cuenta-github-y-git.md` con la estructura de la Fase 0.1, **vacía**. Rellenarla es cosa tuya, después; hoy solo tiene que existir.
...
> **Y antes de grabar: crea la entrada de apuntes de esta fase** (`b0-0.2.1-cuenta-github-y-git.md`) con la estructura pegada y **vacía**. En el vídeo solo tienes que **enseñarla**, no rellenarla.
...
- [ ] Vídeo `B0.2.1 · Cuenta de GitHub y Git` subido a la playlist `B0_Prerrequisitos`, con timestamps.
