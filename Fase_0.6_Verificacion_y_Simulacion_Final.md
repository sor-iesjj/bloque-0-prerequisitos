...
> 1. **Prepárate primero (sin grabar):** repasa mentalmente todo el flujo (apuntes y práctica) y **crea la entrada de apuntes de esta fase** en Obsidian: fichero `b0-0.6-simulacion-final.md` con la estructura del **Bloque 0 · Fase 0.1.b**, **vacía**. Rellenarla es cosa tuya, después.
