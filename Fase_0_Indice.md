...
| **0.4** | [[Fase_0.4_Clonar_Practica_Boochan]] | Baja el **material del Bloque 1** (solo lectura) y crea **su copia de `boochan-1`**. Domina `status → commit → push` + **3 retos** de borrado y recuperación. |
